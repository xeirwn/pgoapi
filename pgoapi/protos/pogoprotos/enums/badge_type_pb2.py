...
_BADGETYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='BADGE_PIKACHU_OUTBREAK_YOKOHAMA_2017', index=47, number=2002,
      options=None,
      type=None),
  ],
