...
_EGGINCUBATOR = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='item_id', full_name='pogoprotos.inventory.EggIncubator.item_id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='item', full_name='pogoprotos.inventory.EggIncubator.item', index=1,
...
_EGGINCUBATOR.fields_by_name['item'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
