...
_ITEMID = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_POKEMON_STORAGE_UPGRADE', index=32, number=1001,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_ITEM_STORAGE_UPGRADE', index=33, number=1002,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_SUN_STONE', index=34, number=1101,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_METAL_COAT', index=36, number=1103,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_DRAGON_SCALE', index=37, number=1104,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_UP_GRADE', index=38, number=1105,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_MOVE_REROLL_FAST_ATTACK', index=39, number=1201,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_MOVE_REROLL_SPECIAL_ATTACK', index=40, number=1202,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_RARE_CANDY', index=41, number=1301,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_PAID_RAID_TICKET', index=43, number=1402,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='ITEM_LEGENDARY_RAID_TICKET', index=44, number=1403,
      options=None,
      type=None),
  ],
