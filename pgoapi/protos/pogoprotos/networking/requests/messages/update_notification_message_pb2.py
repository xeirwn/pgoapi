...
_sym_db.RegisterEnumDescriptor(_UPDATENOTIFICATIONMESSAGE_NOTIFICATIONSTATE)
...
_UPDATENOTIFICATIONMESSAGE = _descriptor.Descriptor(
  ...
  nested_types=[],
  enum_types=[
    _UPDATENOTIFICATIONMESSAGE_NOTIFICATIONSTATE,
  ],
  options=None,
  is_extendable=False,
  syntax='proto3',
...
_UPDATENOTIFICATIONMESSAGE_NOTIFICATIONSTATE.containing_type = _UPDATENOTIFICATIONMESSAGE
