...
_REQUESTTYPE = _descriptor.EnumDescriptor(
  ...
  values=[
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='AWARD_POKECOIN', index=59, number=167,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
    ...
    _descriptor.EnumValueDescriptor(
      ...
      type=None),
    _descriptor.EnumValueDescriptor(
      name='FETCH_ALL_NEWS', index=85, number=816,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='MARK_READ_NEWS_ARTICLE', index=86, number=817,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='REGISTER_PUSH_NOTIFICATION', index=87, number=5000,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UNREGISTER_PUSH_NOTIFICATION', index=88, number=5001,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='UPDATE_NOTIFICATION_STATUS', index=89, number=5002,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='OPT_OUT_PUSH_NOTIFICATION_CATEGORY', index=90, number=5003,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='DOWNLOAD_GAME_MASTER_TEMPLATES', index=91, number=5004,
      options=None,
      type=None),
    _descriptor.EnumValueDescriptor(
      name='GET_INVENTORY', index=92, number=5005,
      options=None,
      type=None),
  ],
