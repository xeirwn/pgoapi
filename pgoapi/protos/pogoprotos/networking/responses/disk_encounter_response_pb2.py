...
_DISKENCOUNTERRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pokemon', full_name='pogoprotos.networking.responses.DiskEncounterResponse.pokemon', index=1,
...
_DISKENCOUNTERRESPONSE.fields_by_name['pokemon'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
