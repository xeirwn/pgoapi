...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n@pogoprotos/networking/responses/download_settings_response.proto\x12\x1fpogoprotos.networking.responses\x1a)pogoprotos/settings/global_settings.proto\"l\n\x18\x44ownloadSettingsResponse\x12\r\n\x05\x65rror\x18\x01 \x01(\t\x12\x0c\n\x04sha1\x18\x02 \x01(\t\x12\x33\n\x06values\x18\x03 \x01(\x0b\x32#.pogoprotos.settings.GlobalSettingsb\x06proto3')
  ,
...
_DOWNLOADSETTINGSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='sha1', full_name='pogoprotos.networking.responses.DownloadSettingsResponse.sha1', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='values', full_name='pogoprotos.networking.responses.DownloadSettingsResponse.values', index=2,
...
_DOWNLOADSETTINGSRESPONSE.fields_by_name['values'].message_type = pogoprotos_dot_settings_dot_global__settings__pb2._GLOBALSETTINGS
