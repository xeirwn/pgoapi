...
_ENCOUNTERRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='pokemon', full_name='pogoprotos.networking.responses.EncounterResponse.pokemon', index=0,
...
_ENCOUNTERRESPONSE.fields_by_name['pokemon'].message_type = pogoprotos_dot_map_dot_pokemon_dot_wild__pokemon__pb2._WILDPOKEMON
