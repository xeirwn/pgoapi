...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n;pogoprotos/networking/responses/fort_details_response.proto\x12\x1fpogoprotos.networking.responses\x1a\"pogoprotos/data/pokemon_data.proto\x1a%pogoprotos/data/raid/event_info.proto\x1a!pogoprotos/enums/team_color.proto\x1a#pogoprotos/map/fort/fort_type.proto\x1a\'pogoprotos/map/fort/fort_modifier.proto\"\xb6\x03\n\x13\x46ortDetailsResponse\x12\n\n\x02id\x18\x01 \x01(\t\x12\x0c\n\x04team\x18\x02 \x01(\x05\x12-\n\x07pokemon\x18\x03 \x03(\x0b\x32\x1c.pogoprotos.data.PokemonData\x12\x0c\n\x04name\x18\x04 \x01(\t\x12\x11\n\timage_url\x18\x05 \x03(\t\x12\n\n\x02\x66p\x18\x06 \x01(\x05\x12\x0f\n\x07stamina\x18\x07 \x01(\x05\x12\x13\n\x0bmax_stamina\x18\x08 \x01(\x05\x12\x30\n\tfort_type\x18\t \x01(\x0e\x32\x1d.pogoprotos.map.fort.FortType\x12\x10\n\x08latitude\x18\n \x01(\x01\x12\x11\n\tlongitude\x18\x0b \x01(\x01\x12\x13\n\x0b\x64\x65scription\x18\x0c \x01(\t\x12\x33\n\x08modifier\x18\r \x03(\x0b\x32!.pogoprotos.map.fort.FortModifier\x12\x12\n\nclose_soon\x18\x0e \x01(\x08\x12\x19\n\x11\x63heckin_image_url\x18\x0f \x01(\t\x12\x33\n\nevent_info\x18\x10 \x01(\x0b\x32\x1f.pogoprotos.data.raid.EventInfob\x06proto3')
  ,
...
_FORTDETAILSRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='id', full_name='pogoprotos.networking.responses.FortDetailsResponse.id', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='team', full_name='pogoprotos.networking.responses.FortDetailsResponse.team', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pokemon', full_name='pogoprotos.networking.responses.FortDetailsResponse.pokemon', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='image_url', full_name='pogoprotos.networking.responses.FortDetailsResponse.image_url', index=4,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='fort_type', full_name='pogoprotos.networking.responses.FortDetailsResponse.fort_type', index=8,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='modifier', full_name='pogoprotos.networking.responses.FortDetailsResponse.modifier', index=12,
...
_FORTDETAILSRESPONSE.fields_by_name['pokemon'].message_type = pogoprotos_dot_data_dot_pokemon__data__pb2._POKEMONDATA
_FORTDETAILSRESPONSE.fields_by_name['fort_type'].enum_type = pogoprotos_dot_map_dot_fort_dot_fort__type__pb2._FORTTYPE
_FORTDETAILSRESPONSE.fields_by_name['modifier'].message_type = pogoprotos_dot_map_dot_fort_dot_fort__modifier__pb2._FORTMODIFIER
