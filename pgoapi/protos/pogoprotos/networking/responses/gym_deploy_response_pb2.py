...
_GYMDEPLOYRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='cooldown_duration_millis', full_name='pogoprotos.networking.responses.GymDeployResponse.cooldown_duration_millis', index=3,
