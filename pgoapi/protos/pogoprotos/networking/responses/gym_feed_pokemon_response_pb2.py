...
_GYMFEEDPOKEMONRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='gym_badge', full_name='pogoprotos.networking.responses.GymFeedPokemonResponse.gym_badge', index=2,
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='candy_family_id', full_name='pogoprotos.networking.responses.GymFeedPokemonResponse.candy_family_id', index=6,
...
_GYMFEEDPOKEMONRESPONSE.fields_by_name['gym_badge'].message_type = pogoprotos_dot_data_dot_badge_dot_awarded__gym__badge__pb2._AWARDEDGYMBADGE
_GYMFEEDPOKEMONRESPONSE.fields_by_name['candy_family_id'].enum_type = pogoprotos_dot_enums_dot_pokemon__family__id__pb2._POKEMONFAMILYID
