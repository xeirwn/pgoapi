...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n9pogoprotos/networking/responses/set_avatar_response.proto\x12\x1fpogoprotos.networking.responses\x1a!pogoprotos/data/player_data.proto\"\x96\x02\n\x11SetAvatarResponse\x12I\n\x06status\x18\x01 \x01(\x0e\x32\x39.pogoprotos.networking.responses.SetAvatarResponse.Status\x12+\n\x06player\x18\x02 \x01(\x0b\x32\x1b.pogoprotos.data.PlayerData\"\x88\x01\n\x06Status\x12\t\n\x05UNSET\x10\x00\x12\x0b\n\x07SUCCESS\x10\x01\x12\x16\n\x12\x41VATAR_ALREADY_SET\x10\x02\x12\x0b\n\x07\x46\x41ILURE\x10\x03\x12\x14\n\x10SLOT_NOT_ALLOWED\x10\x04\x12\x12\n\x0eITEM_NOT_OWNED\x10\x05\x12\x17\n\x13INVALID_AVATAR_TYPE\x10\x06\x62\x06proto3')
  ,
...
_SETAVATARRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='player', full_name='pogoprotos.networking.responses.SetAvatarResponse.player', index=1,
...
_SETAVATARRESPONSE.fields_by_name['player'].message_type = pogoprotos_dot_data_dot_player__data__pb2._PLAYERDATA
...
SetAvatarResponse = _reflection.GeneratedProtocolMessageType('SetAvatarResponse', (_message.Message,), dict(
  ...
  __module__ = 'pogoprotos.networking.responses.set_avatar_response_pb2'
