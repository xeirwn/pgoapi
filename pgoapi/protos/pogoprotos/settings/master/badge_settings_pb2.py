...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n/pogoprotos/settings/master/badge_settings.proto\x12\x1apogoprotos.settings.master\x1a!pogoprotos/enums/badge_type.proto\x1a\x30pogoprotos/data/badge/badge_capture_reward.proto\"\xbe\x01\n\rBadgeSettings\x12/\n\nbadge_type\x18\x01 \x01(\x0e\x32\x1b.pogoprotos.enums.BadgeType\x12\x13\n\x0b\x62\x61\x64ge_ranks\x18\x02 \x01(\x05\x12\x0f\n\x07targets\x18\x03 \x03(\x05\x12\x41\n\x0e\x63\x61pture_reward\x18\x04 \x03(\x0b\x32).pogoprotos.data.badge.BadgeCaptureReward\x12\x13\n\x0b\x65vent_badge\x18\x05 \x01(\x08\x62\x06proto3')
  ,
...
_BADGESETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='badge_ranks', full_name='pogoprotos.settings.master.BadgeSettings.badge_ranks', index=1,
