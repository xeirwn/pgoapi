...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n1pogoprotos/settings/master/iap_item_display.proto\x12\x1apogoprotos.settings.master\x1a(pogoprotos/enums/iap_item_category.proto\x1a\'pogoprotos/inventory/item/item_id.proto\"\xac\x01\n\x0eIapItemDisplay\x12\x0b\n\x03sku\x18\x01 \x01(\t\x12\x37\n\x08\x63\x61tegory\x18\x02 \x01(\x0e\x32%.pogoprotos.enums.HoloIapItemCategory\x12\x12\n\nsort_order\x18\x03 \x01(\x05\x12\x30\n\x05items\x18\x04 \x03(\x0e\x32!.pogoprotos.inventory.item.ItemId\x12\x0e\n\x06\x63ounts\x18\x05 \x03(\x05\x62\x06proto3')
  ,
...
_IAPITEMDISPLAY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='items', full_name='pogoprotos.settings.master.IapItemDisplay.items', index=3,
...
_IAPITEMDISPLAY.fields_by_name['items'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
