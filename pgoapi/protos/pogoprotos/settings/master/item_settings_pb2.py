...
_ITEMSETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='unique_id', full_name='pogoprotos.settings.master.ItemSettings.unique_id', index=0,
...
_ITEMSETTINGS.fields_by_name['unique_id'].enum_type = pogoprotos_dot_inventory_dot_item_dot_item__id__pb2._ITEMID
