...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n8pogoprotos/settings/master/type_effective_settings.proto\x12\x1apogoprotos.settings.master\x1a#pogoprotos/enums/pokemon_type.proto\"b\n\x15TypeEffectiveSettings\x12\x32\n\x0b\x61ttack_type\x18\x02 \x01(\x0e\x32\x1d.pogoprotos.enums.PokemonType\x12\x15\n\rattack_scalar\x18\x01 \x03(\x02\x62\x06proto3')
  ,
...
_TYPEEFFECTIVESETTINGS = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='attack_type', full_name='pogoprotos.settings.master.TypeEffectiveSettings.attack_type', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='attack_scalar', full_name='pogoprotos.settings.master.TypeEffectiveSettings.attack_scalar', index=1,
